...
contract MyToken is ERC721, ERC721URIStorage, Ownable {
    ...
    function setTokenURI1(string memory _uri) external onlyOwner{
        tokenURI1 = _uri;
    }

    function setTokenURI2(string memory _uri) external onlyOwner{
        tokenURI2 = _uri;
    }

    function setTokenURI3(string memory _uri) external onlyOwner{
        tokenURI3 = _uri;
    }
